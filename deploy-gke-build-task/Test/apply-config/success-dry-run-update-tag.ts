...
/**
 * @fileoverview This is a test script for the deploy gke task
 *    sucessfully performing a dry run.
...
runner.setInput('dryRun', 'true');

const answers = tc.getDefaultAnswers();
answers.exec[tc.kubectlApplyDryRunExecString] = tc.successResult;
runner.setAnswers(answers);
mocks.registerCommonMocks(runner, tc.configs.json.map);
