 ...
 *   a failing "kubectl scale deployment" call.
...
runner.setInput('imageTag', tc.newImageTag);
...
answers.exec[tc.kubectlScaleExecString] = tc.failResult;
answers.exec[tc.kubectlSetImageExecString] = tc.successResult;
