...
runner.setInput('replicas', tc.replicas);
runner.setInput('dryRun', 'true');

const answers = tc.getDefaultAnswers();
answers.exec[tc.kubectlGetDeploymentsExecString] = tc.emptyDeploymentResult;
answers.exec[tc.kubectlRunDryRunExecString] = tc.successResult;
